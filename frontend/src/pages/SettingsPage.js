...
const RELEASE_NOTES = [
  { version:'1.5.4', date:'2026-03-24', notes:'Fix: receipt missing Qty header; rental rate showing 0 (not stored in row aggregator); header now shows "Rental Cost" vs "Replacement Value" dynamically' },
